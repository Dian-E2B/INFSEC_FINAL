$(document).ready(function () {
  ...
  var dataTable = $('#dt-suppliers').DataTable({
    ...
    "ajax": {
      url: "../../app/controllers/suppliers/view.php",
      type: "POST"
    },
    "columnDefs": [{
      "targets": [4],
  ...
  $(document).on('submit', '#form-supplier', function (event) {
    ...
    $.ajax({
      url: "../../app/controllers/suppliers/create.php",
      method: 'POST',
  ...
  $(document).on('click', '.update', function () {
    var id = $(this).attr("id");
    $.ajax({
      url: "../../app/controllers/suppliers/edit.php",
      method: "POST",
      data: {
        id: id
      },
  ...
  $(document).on('click', '.delete', function () {
    ...
    $("#btn-delete").click(function () {
      $.ajax({
        url: "../../app/controllers/suppliers/delete.php",
        method: "POST",
        data: {
          id: id
        },
